...
//check developer in the database
   ...
   WHERE dev.user_id=user.user_id AND dev.approval = 0 AND dev.dev_team_id = dev_team.dev_team_id AND dev_team.team_admin_id =$id";
   ...
   WHERE dev.user_id=user.user_id AND dev.approval = 1 AND dev.dev_team_id = dev_team.dev_team_id AND dev_team.team_admin_id =$id";
      ...
      <section>
        ...
        <div class="container">
            <ul class="collection with-header">
                <li class="collection-header indigo lighten-1"><a href="devregister.php" class="white-text"><h4>Approved Users</h4></a></li>
                <li class="collection-item">
                  ...
                  <?php foreach ($approved as $approved) {?>
                      <div class="row">
                            ...
                            <div class="col s2"><a class="brand-text" href="1devunapprove.php?user_id=<?php echo htmlspecialchars($approved['user_id']); ?>">Unapprove</a></div>
                            <div class="col s2"><a class="brand-text" href="1devdelete.php?user_id=<?php echo htmlspecialchars($approved['user_id']); ?>">Delete</a></div>
                            </div>
                  <?php  }?>
              </li>
...
<div class="container">
    <ul class="collection with-header">
        <li class="collection-header indigo lighten-1"><a href="devteamregister.php" class="white-text"><h4>Requested Users</h4></a></li>
        <li class="collection-item">
          <div class="row">
                <div class="col s2">User ID</div>
                <div class="col s3">Username</div>
          ...
          <?php foreach ($not_approved as $not_approved) {?>
              <div class="row">
                    ...
                    <div class="col s2"><a class="brand-text" href="1devapprove.php?user_id=<?php echo htmlspecialchars($not_approved['user_id']); ?>">Approve</a></div>
                    <div class="col s2"><a class="brand-text" href="1devdelete.php?user_id=<?php echo htmlspecialchars($not_approved['user_id']); ?>">Delete</a></div>
                    </div>
          <?php  }?>
      </li>
