...
if (isset($_SESSION["log_username"])) {
  ...
  if (isset($_POST['submit'])) {
      $buy_sql= "INSERT INTO `sales` (`product_id`, `dev_team_id`,user_id) VALUES ('$productid', '$dev_team_id','$id')";
      $resultb = mysqli_query($conn, $buy_sql);
  ...
  <div class="container indigo darken-2 z-depth-4">
             ...
             <div class="card z-depth-4">
                 ...
                 <div class="card-content indigo accent-3">
                   ...
                   <div class="row">
                     <div class="col s12">
                           <h6 class=" grey-text text-lighten-3">Check Your Billing Information</h6>
                           <hr>
                         </div>
              ...
              <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                <div class="col s12 l5"><p class=" grey-text text-lighten-3">Payment Method</p><p class=" grey-text text-lighten-3"><?php echo $method ?></p><hr></div>
                         </div>

                          <div class="row">
                            <div class="col s12 l3"><p class=" grey-text text-lighten-3">First Name</p><p class=" grey-text text-lighten-3"><?php echo$fname ?></p><hr></div>
                            <div class="col s12 l3"><p class=" grey-text text-lighten-3">Last Name</p><p class=" grey-text text-lighten-3"><?php echo$lname ?></p><hr></div>
                            <div class="col s12 l6"><p class=" grey-text text-lighten-3">City</p><p class=" grey-text text-lighten-3"><?php echo$city ?></p><hr></div>
                          </div>
                          <div class="row">
                            <div class="col s12 l6"><p class=" grey-text text-lighten-3">Billing address</p><p class=" grey-text text-lighten-3"><?php echo$billaddress ?></p><hr></div>
                            <div class="col s12 l6"><p class=" grey-text text-lighten-3">Zip or postal code</p><p class=" grey-text text-lighten-3"><?php echo$zip ?></p><hr></div>
                          </div>
                          <div class="row">
                            <div class="col s12 l6"><p class=" grey-text text-lighten-3">Billing address, line 2</p><p class=" grey-text text-lighten-3"><?php echo$billaddress2 ?></p><hr></div>
                          </div>
                          <div class="row">
                            <div class="col s12 l6"><p class=" grey-text text-lighten-3">Phone Number</p><p class=" grey-text text-lighten-3"><?php echo$phno ?></p><hr></div>
                            <div class="col s12 l6" style="position:relative; top:10px;"><p class=" grey-text text-lighten-3"><?php echo$country ?></p><hr></div>
                          </div>

                          <div class="row">
                            <div class="col s6 l3 right"><input class="btn-large hoverable indigo lighten-1" type="submit" name="submit" value="Purchase"></div>
                            <div class="col s6 l2 right"><a href="checkout.php?productid=<?php echo$getproduct ?>" class="btn-large hoverable indigo lighten-1">Go Back</a></div>
                          </div>
