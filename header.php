            ...
            <div class="hcontainer">
              <div class="row">
                ...
                <div class="col s3 l1 logo center-align">
                  <h3><a href="index.php">Galaxy</a></h3>
                ...
                <div class="col l8">
                  <ul class="hide-on-med-and-down">
                    <li><a href="index.php" class="btn-large btn-hover indigo darken-2" style="width:100px;">Home</a></li>
                    ...
                    <li><a href="login.php" class="btn-large btn-hover indigo darken-2"style="width:180px;">User Login</a></li>
                  </ul>
                </div>

                <div class="col l2 hide-on-med-and-down">
                  <li><a href="index.php" class="btn-large g indigo darken-4"><h6>Get Galaxy Client</h6></a></li>
                </div>
                <div class="col s2">
